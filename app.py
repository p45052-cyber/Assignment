...
if st.button('Predict'):
    ...
    if not duration or not base_fare or not tax_surcharge or not days_before_departure:
        ...
        try:
            ...
            st.error(f"Error: Please enter valid numerical values for all input fields. The values received were: Duration='{duration}', Base Fare='{base_fare}', Tax Surcharge='{tax_surcharge}', Days Before Departure='{days_before_departure}'")
